...
class TestWizard(common.TransactionCase):
    ...
    def test_wizard(self):
        ...
        list_rule_basic = [("l10n_ch_hr_payroll.BASIC_CH", "debit")]
        list_rule_net = [("l10n_ch_hr_payroll.NET_CH", "credit")]
        list_rule_avs_d = [
        ...
        list_rule_lpp_c = [("l10n_ch_hr_payroll.LPP_C", "credit")]
        list_rule_laa_c = [
        ...
        list_rule_other_costs = [("l10n_ch_hr_payroll.FADMIN", "debit")]

        # Test if all the rules from the list have the same id as given
        self.assertEqual(
            True,
            rules_acc_equal_test(self, list_rule_cc, "5000", self.account_1),
        )
        self.assertEqual(
            True,
        ...
        self.assertEqual(
            True,
            rules_acc_equal_test(self, list_rule_net, "5800", self.account_3),
        )
        self.assertEqual(
            True,
